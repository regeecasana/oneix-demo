...
export const caseFiles: Record<string, CaseFile> = {
  ...
  disruption: {
    ...
    steps: [
      "FLIGHT_DELAYED OA720 SIN-HND +210 MIN received",
      "Affected passengers identified from the booking",
      "CRM history and seat/baggage preferences loaded",
      "Alternatives checked; OA712 offered under disruption policy",
      "Consent and channel checked; WhatsApp message sent",
      "Inventory held, waiver ticket exchange authorized",
      "Seat 18C restored; itinerary emailed",
      "App reminder moved to 4:45 AM",
      "Unused S$48 seat charge refunded (RF-804312)",
    ],
